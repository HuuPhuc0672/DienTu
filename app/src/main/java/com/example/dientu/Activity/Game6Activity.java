    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Game6Activity.this, "Bạn đã chọn đúng", Toast.LENGTH_SHORT).show();
        ...
        btnSai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Game6Activity.this, "Bạn Chọn Sai. Mời Bạn Chọn Lại", Toast.LENGTH_SHORT).show();
            }
        });
